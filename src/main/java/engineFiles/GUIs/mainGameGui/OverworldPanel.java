...
public class OverworldPanel extends GamePanel {
    ...
    public Image getRenderGraphics() {
         ...
         * 
         * if(offest.getBounds().intersects(s.getCoord().getBounds())){ result.add(s); }
         * }
         */
         ...
         * if(offest.getBounds().intersects(e.getCoord().getBounds())){ result.add(e); }
         * }
         * 
         * Entity p = getPlayer(); ControllableEntity nextP = new
         * ControllableEntity(p.getAnimation(), p.getOgFile()); nextP.setName("JIGGLY");
         * nextP.setCoord(new Coordinates(p.getCoord().getX() + 30, p.getCoord().getY()
         * + 30, p.getCoord().getZ(), p.getCurrentWidth(), p.getCurrentHeight()));
         * result.add(nextP); Entity p2 = getPlayer(); ControllableEntity nextP2 = new
         * ControllableEntity(p.getAnimation(), p.getOgFile());
         * nextP2.setName("JIGGLY"); nextP2.setCoord(new
         * Coordinates(p2.getCoord().getX() + 60, p2.getCoord().getY() + 15,
         * p2.getCoord().getZ(), p2.getCurrentWidth(), p2.getCurrentHeight()));
         * result.add(nextP2); // System.out.println(result.size());
         * 
         */
    }
