...
public class GameContainer {
    ...
    public static void main(String[] args) {
        ...
        //COLORING
        String inputDir = "project/src/gameFiles/models/sprites/tilesets/basictiles.png";
        String outputDir = "project/src/playerGameFiles/sprites/tilesets/basictiles.png";
